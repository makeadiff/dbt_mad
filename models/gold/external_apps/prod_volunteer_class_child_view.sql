...
-- Volunteer Class Child View: operational view connecting volunteers to slots and children
...
--   - excludes removed/cancelled volunteer-slot assignments (legacy filtered scsv.removed = FALSE)
--   - keeps allocations tied to removed slots/children/partners (legacy didn't filter those out)
